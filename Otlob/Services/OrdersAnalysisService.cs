...
{
    public class OrdersAnalysisService : IOrdersAnalysisService
    {
        private readonly IOrderService orderService;

        public OrdersAnalysisService(IOrderService orderService)
        {
           ...
           OrdersAnalysisVM ordersAnalysisVM = new()
            {
                ...
                ordersOverLastTwelveMonths = GetOrdersOverLastTwelveMonth().ToList()
            };
