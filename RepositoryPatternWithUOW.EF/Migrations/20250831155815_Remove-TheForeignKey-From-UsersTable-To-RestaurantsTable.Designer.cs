...
namespace Otlob.EF.Migrations
{
    ...
    [Migration("20250831155815_Remove-TheForeignKey-From-UsersTable-To-RestaurantsTable")]
    partial class RemoveTheForeignKeyFromUsersTableToRestaurantsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Otlob.Core.Models.Restaurant", b =>
                {
                    b.HasOne("Otlob.Core.Models.ApplicationUser", "User")
                        .WithOne("Restaurant")
                        .HasForeignKey("Otlob.Core.Models.Restaurant", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
