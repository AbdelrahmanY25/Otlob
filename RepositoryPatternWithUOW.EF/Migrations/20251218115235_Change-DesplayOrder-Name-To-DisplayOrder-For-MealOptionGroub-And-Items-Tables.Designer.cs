...
namespace Otlob.EF.Migrations
{
    ...
    [Migration("20251218115235_Change-DisplayOrder-Name-To-DisplayOrder-For-MealOptionGroub-And-Items-Tables")]
    partial class ChangeDisplayOrderNameToDisplayOrderForMealOptionGroubAndItemsTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Otlob.Core.Entities.MealOptionItem", b =>
                {
                    ...
                    b.Property<string>("OptionGroupMealOptionGroupId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("OptionGroupMealOptionGroupId");
            ...
            modelBuilder.Entity("Otlob.Core.Entities.MealOptionItem", b =>
                {
                    b.HasOne("Otlob.Core.Entities.MealOptionGroup", "OptionGroup")
                        ...
                        .HasForeignKey("OptionGroupMealOptionGroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
