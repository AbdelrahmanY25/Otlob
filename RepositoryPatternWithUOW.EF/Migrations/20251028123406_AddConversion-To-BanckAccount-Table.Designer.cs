...
namespace Otlob.EF.Migrations
{
    ...
    [Migration("20251028123406_AddConversion-To-BanckAccount-Table")]
    partial class AddConversionToBanckAccountTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Otlob.Core.Entities.NationalId", b =>
                {
                    ...
                    b.Property<string>("BackNationalCardId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("FrontNationalCardId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("BackNationalCardId");

                    b.HasIndex("CreatedById");

                    b.HasIndex("FrontNationalCardId");
            ...
            modelBuilder.Entity("Otlob.Core.Entities.NationalId", b =>
                {
                    b.HasOne("Otlob.Core.Entities.UploadedFile", "BackNationalCard")
                        .WithMany()
                        .HasForeignKey("BackNationalCardId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Otlob.Core.Entities.UploadedFile", "FrontNationalCard")
                        .WithMany()
                        .HasForeignKey("FrontNationalCardId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("BackNationalCard");

                    b.Navigation("CreatedBy");

                    b.Navigation("FrontNationalCard");
